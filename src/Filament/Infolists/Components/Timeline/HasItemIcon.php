...
{
    /**
     * @var array<string, array<string, string|BackedEnum|Closure>>
     */
    protected array $itemIcons = [];

    public function itemIcon(string $event, string | BackedEnum | Closure | null $icon, string | array $subjectScopes = []): static
    {
    ...
    public function getItemIcon(Activity | ActivityModel $activity): string | BackedEnum | null
    {
